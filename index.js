...
function checkemail(email) {
    if (email.length > 8 && email.includes('@gmail')) {
        ...
        document.getElementById('email_error').innerHTML = 'Email length must include @gmail, 8 letters long'
...
function checkpassword(password) {
    if (password.length > 8 && password.includes('.')) {
        ...
        document.getElementById('password_error').innerText = 'Password must 8 letters long and should include .'
    }
}
